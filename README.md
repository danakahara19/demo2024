...
### №1.5 При помощи Iperp 3 измерить пропускную способонсть сети между HQ-R b и ISP
...
ufw allow 5201
```
Теперь с помощью этой команды можно подключаться
```
